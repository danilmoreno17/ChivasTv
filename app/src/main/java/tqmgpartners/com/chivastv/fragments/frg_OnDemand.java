 ...
 * {@link frg_OnDemand.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link frg_OnDemand#newInstance} factory method to
 * create an instance of this fragment.
 */
public class frg_OnDemand extends Fragment {
     ...
     * @return A new instance of fragment frg_OnDemand.
     */
    // TODO: Rename and change types and number of parameters
    public static frg_OnDemand newInstance(String param1, String param2) {
        frg_OnDemand fragment = new frg_OnDemand();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.frg_on_demand, container, false);
    ...
    public void buildGuide(View rootView){
        try
        {
            ...
            arrTitles.add("Featured");
            arrTitles.add("Hot Picks");
            arrTitles.add("Movies");
            ...
            for( int i = 0; i < 3; i++ )
            {
                ...
                final adaOnDemandAdapter objAdaProgrammes = new adaOnDemandAdapter(arrEditorials);
